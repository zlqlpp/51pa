...
logging.basicConfig(filename='tiyanbaogao.log',level=logging.DEBUG)
...
for i in list(range(186)):
        ...
        #with open('/root/python3/tiyanbaogao.txt', 'a+') as f:
        for mm in tiezi:
             time.sleep(1)
             #f.write(str(count)+'--'+str(i)+'---'+mm.text+'\n')
